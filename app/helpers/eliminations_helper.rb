module EliminationsHelper
  ...
  def td_tags__1st_round(elimination:, games:, round_offset:, final_round:, seed_table:)
    ...
    if max == 1
      ...
      tag__tds << tag.td
      tag__tds << tag.td(class: ["game-cell b-top b-right b-bottom", border_top_bottom__a_win_b_win(game)], rowspan: "4") { elimination_game_cell(elimination:, games:, round:, gameNo: 1) }
      ...
      1.upto(max) { |i|
        ...
        if (round_offset >= 1 || (game1_exist && game2_exist))
          # 2試合ともあり。
          tag__tds << tag.td
          tag__tds << tag.td(class: ["game-cell b-top b-right b-bottom", border_top_bottom__a_win_b_win(game1)], rowspan: "4") { elimination_game_cell(elimination:, games:, round:, gameNo: gameNo1) }
          tag__tds += Array.new(3)

          tag__tds << tag.td(rowspan: "4")
          tag__tds += Array.new(3)

          tag__tds << tag.td(class: ["game-cell b-top b-right b-bottom", border_top_bottom__a_win_b_win(game2)], rowspan: "4") { elimination_game_cell(elimination:, games:, round:, gameNo: gameNo2) }
          tag__tds += Array.new(3)
          ...
          tag__tds << tag.td(class: ["game-cell b-top", border_top__a_win(next_game)], rowspan: "6") { elimination_game_cell(elimination:, games:, round: next_round, gameNo: next_gameNo) }
          ...
          tag__tds << tag.td(class: ["game-cell b-bottom", border_bottom__b_win(next_game)], rowspan: "6") { elimination_game_cell(elimination:, games:, round: next_round, gameNo: next_gameNo) }
          tag__tds += Array.new(5)
          ...
          next_round = 2
          next_gameNo = gameNo2 / 2
          tag__tds << tag.td(class: ["game-cell b-top b-bottom", border_top_bottom__a_win_b_win(next_game)], rowspan: "8") { elimination_game_cell(elimination:, games:, round: next_round, gameNo: next_gameNo) }
  ...
  def td_tags__Nth_round(elimination:, games:, round:, round_offset:, final_round:)
    ...
    1.upto(max) do |i|
      ...
      # 内
      tag__tds << tag.td(class: "game-cell b-right", rowspan: width3.to_s) { elimination_game_cell(elimination:, games:, round:, gameNo: i) }
